...
require (
	...
	github.com/mephistolie/chefbook-backend-common/firebase v0.3.0
	github.com/mephistolie/chefbook-backend-common/hash v0.3.0
	github.com/mephistolie/chefbook-backend-common/log v0.3.0
	github.com/mephistolie/chefbook-backend-common/mail v0.3.0
	github.com/mephistolie/chefbook-backend-common/migrate/sql v0.3.0
