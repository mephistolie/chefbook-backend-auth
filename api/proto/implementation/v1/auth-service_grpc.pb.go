...
const (
	...
	AuthService_CheckUsernameAvailability_FullMethodName = "/v1.AuthService/CheckUsernameAvailability"
	AuthService_SetUsername_FullMethodName               = "/v1.AuthService/SetUsername"
)
...
func (c *authServiceClient) ActivateProfile(ctx context.Context, in *ActivateProfileRequest, opts ...grpc.CallOption) (*ActivateProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_ActivateProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetAccessTokenPublicKey(ctx context.Context, in *GetAccessTokenPublicKeyRequest, opts ...grpc.CallOption) (*GetAccessTokenPublicKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_GetAccessTokenPublicKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetProfileDeletionStatus(ctx context.Context, in *GetProfileDeletionStatusRequest, opts ...grpc.CallOption) (*GetProfileDeletionStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_GetProfileDeletionStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) CancelProfileDeletion(ctx context.Context, in *CancelProfileDeletionRequest, opts ...grpc.CallOption) (*CancelProfileDeletionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_CancelProfileDeletion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) RequestGoogleOAuth(ctx context.Context, in *RequestGoogleOAuthRequest, opts ...grpc.CallOption) (*RequestGoogleOAuthResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_RequestGoogleOAuth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) SignInGoogle(ctx context.Context, in *SignInGoogleRequest, opts ...grpc.CallOption) (*SessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SessionResponse)
	err := c.cc.Invoke(ctx, AuthService_SignInGoogle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) SignInGoogleToken(ctx context.Context, in *SignInGoogleTokenRequest, opts ...grpc.CallOption) (*SessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SessionResponse)
	err := c.cc.Invoke(ctx, AuthService_SignInGoogleToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) ConnectGoogle(ctx context.Context, in *ConnectGoogleRequest, opts ...grpc.CallOption) (*ConnectGoogleResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_ConnectGoogle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) DeleteGoogleConnection(ctx context.Context, in *DeleteGoogleConnectionRequest, opts ...grpc.CallOption) (*DeleteGoogleConnectionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_DeleteGoogleConnection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) RequestVkOAuth(ctx context.Context, in *RequestVkOAuthRequest, opts ...grpc.CallOption) (*RequestVkOAuthResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_RequestVkOAuth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) SignInVk(ctx context.Context, in *SignInVkRequest, opts ...grpc.CallOption) (*SessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SessionResponse)
	err := c.cc.Invoke(ctx, AuthService_SignInVk_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) ConnectVk(ctx context.Context, in *ConnectVkRequest, opts ...grpc.CallOption) (*ConnectVkResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_ConnectVk_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) DeleteVkConnection(ctx context.Context, in *DeleteVkConnectionRequest, opts ...grpc.CallOption) (*DeleteVkConnectionResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_DeleteVkConnection_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) EndSessions(ctx context.Context, in *EndSessionsRequest, opts ...grpc.CallOption) (*EndSessionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_EndSessions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetVisibleNames(ctx context.Context, in *GetVisibleNamesRequest, opts ...grpc.CallOption) (*GetVisibleNamesResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_GetVisibleNames_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) SetUsername(ctx context.Context, in *SetUsernameRequest, opts ...grpc.CallOption) (*SetUsernameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetUsernameResponse)
	err := c.cc.Invoke(ctx, AuthService_SetUsername_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) SetUsername(context.Context, *SetUsernameRequest) (*SetUsernameResponse, error) {
...
func _AuthService_SetUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetUsernameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).SetUsername(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_SetUsername_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SetUsername(ctx, req.(*SetUsernameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_SetUsername_Handler,
		},
	},
